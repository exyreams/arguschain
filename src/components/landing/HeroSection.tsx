...
import { Activity, ArrowRight, BarChart3, Code, Shield } from "lucide-react";
...
export const HeroSection: React.FC<HeroSectionProps> = ({ user, isLoaded }) => {
  ...
  const features = [
    {
      ...
      description: "Deep transaction security auditing",
    },
    {
      icon: Code,
    ...
    },
    {
      ...
      description: "Advanced gas usage analytics",
    },
  ];

  const metrics = [
    { value: "2.1M+", label: "Transactions Analyzed" },
    { value: "50K+", label: "Blocks Traced" },
  ...
  return (
    <div className="relative min-h-screen bg-[#0f1419] overflow-hidden">
      <div
        className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl bg-[#00bfff]/20 transition-transform"
        style={{
          width: 150,
          height: 150,
          left: cursor.x,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="space-y-6">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#00bfff]/10 to-[#0ea5e9]/10 border border-[#00bfff]/30 rounded-full text-sm font-medium text-[#00bfff] backdrop-blur-sm">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold leading-tight tracking-tight">
              ...
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00bfff] via-[#0ea5e9] to-[#38bdf8]">
                Blockchain
              </span>
              <br />
            ...
            <p className="text-lg text-[#94a3b8] max-w-2xl leading-relaxed">
              Advanced transaction tracing, smart contract analysis, and gas
              optimization for developers, auditors, and blockchain researchers.
              Decode complex blockchain interactions with enterprise-grade
              precision.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className={`flex items-center gap-4 p-4 bg-[rgba(15,23,42,0.6)] backdrop-blur-sm border border-[#1e293b] rounded-lg hover:border-[#00bfff]/30 transition-all duration-300 ${
                  animationPhase
              ...
              >
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#00bfff]/20 to-[#0ea5e9]/20 rounded-lg flex items-center justify-center border border-[#00bfff]/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/auth" className="flex-1">
              <Button
                size="lg"
                className="w-full group bg-gradient-to-r from-[#00bfff] to-[#0ea5e9] hover:from-[#0ea5e9] hover:to-[#38bdf8] border-0 text-white font-semibold"
              >
            ...
            <Button
              variant="outline"
              size="lg"
              className="flex-1 border-[#334155] text-[#94a3b8] hover:border-[#00bfff]/50 hover:text-white hover:bg-[#00bfff]/10"
            >
              View Demo
            </Button>
          </div>
        ...
        >
          <div className="w-full flex justify-center ml-8">
            <svg
              ...
              viewBox="0 0 853.04 762.9"
              className="w-[800px] h-auto"
            >
              <defs>
                <style>
                  {`
                  #Layer_1-2 path, #Layer_1-2 polygon {
                    fill: transparent;
                    stroke: #00bfff;
                    stroke-width: 2px;
                  ...
                  @keyframes draw-fill {
                    ...
                    80% { stroke-dashoffset: 0; fill: #00bfff; }
                    100% { stroke-dashoffset: 0; fill: #00bfff; }
                  }
                  `}
                </style>
              </defs>
